...
import json
import urllib2
token = "c9589bf2a0c8f19850b50cd4f49a2bef2498a4022aaa0c43d89ba6bf9467db72"
...
def getPeople(oppId, numberOfPages):
    ...
    resultado += "," + str(opens) + "," + str(rejected) + "," + str(favourite) 
    resultado += "," + str(withdrawn) +"\n"
    return resultado
...
def main():
    ...
    with open(filepath) as fp:  
       line = fp.readline()
       resultado = ""
       encabezados = "opID, oppName, Company, Comitee,  DayCreated, TotalApplicants, openApplicants, rejected, favourite, withdrawn\n"

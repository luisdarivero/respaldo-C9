...
#The source code contained in ths file is used to test the TableGenerator Class and it´s sub-classes
require 'minitest/autorun'
require 'table_generator'
require 'student'

#A class that call the tests of TableGenerator Class and uses the Class of Student
class TableGeneratorTest < Minitest::Test
    #create 2 lists with specific data to test
  def setup
    @headerEmpty = []
    @dataEmpty = []
...
#makes the test of CSVTableGenerator Class
  ...
  #makes the test of HTMLTableGenerator Class
  def test_HTMLTableGenerator
    ...
    #makes the test of AsciiTableGenerator Class

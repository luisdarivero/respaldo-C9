...
public class part1{
    ...
    public enum TokenCategory{
        EOF, ARTICLE, NOUN, NAME, PRONOUN, VERB, ADJ, PREP, ILLEGAL
    }
...
public class Parser{
    ...
    public void noun_phrase(){
        if(Current == TokenCategory.NAME){
            Expect(TokenCategory.NAME);
            return;
        }
        else if(Current == TokenCategory.PRONOUN){
            Expect(TokenCategory.PRONOUN);
            return;
        }
        else if(Current == TokenCategory.ARTICLE){
    ...
    public void verb_phrase(){
        Expect(TokenCategory.VERB);
        noun_phrase();
        pp_list();
    }
    
    public void adj_list(){
    ...
    public static void Main(String [] args){
        while(true){
            Console.Write("Inserta la oración: ");
